...
### Коммит 1.1: `feat: setup addressable profiles and groups structure`
...
### Коммит 1.2: `feat: implement addressable labels and asset organization`
...
### Коммит 1.3: `feat: configure separate catalogs for content updates`
...
**Следующий шаг**: Коммит 1.1 - создание базовой структуры файлов
